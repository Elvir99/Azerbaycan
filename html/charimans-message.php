...
<div class="d-flex text-white header-link ms-5 mt-4 f-13">
    ...
    <ul>
        <li><a href="#" class="text-white ms-3">İdarə heyyəti sədrinin mesajı</a></li>
    </ul>
</div>


<div class="container-fluid history text-white pb-4 mb-4">
   <h4 class=" ms-4 pt-4 fw-bold f-22 f-md-36">İdarə heyyəti sədrinin mesajı</h4>

   
   <div class="row g-0 mt-4">

       <div class="col-12 col-sm-4 d-flex justify-content-center image-area-9">
       <img src="../images/Group306.png" class="img-fluid me-2">
       </div>

       <div class="col-12 col-sm-8 text-dark rounded text-area-9">

           <div class="bg-white h-100 p-4 mt-1 rounded h-100 me-2">
               <h5 class="fw-bold f-md-21">What is Lorem Ipsum?</h5>
               <p class=" f-12 f-md-16">
               ...
               <p class=" f-12 f-md-16">Why do we use it? It is a long established fact that a reader will be distracted by the readable content of a page when
